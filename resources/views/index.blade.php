                            ...
                            <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="screen bg-black">
                                    ...
                                    <video muted="muted" autoplay="" loop=""
                                        ...
                                        <source src="assets/assets/img/demo-screen.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="assets/assets/img/tnw-logo.svg" alt="..." style="height: 3rem" />
                </div>
            </div>
        </div>
    </aside>
    ...
    <section class="bg-gradient-primary-to-secondary" id="download">
        <div class="container px-5">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-center justify-content-center">
                <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge"
                        src="assets/assets/img/google-play-badge.svg" alt="..." /></a>
                <a href="#!"><img class="app-badge" src="assets/assets/img/app-store-badge.svg" alt="..." /></a>
            </div>
        </div>
    </section>
@endsection
